...
<body class="bg-secondary">
  ...
  <aside class="sidebar-container px-3 py-4 bg-white shadow-sm" id="sidebar">
    ...
    <ul>
      ...
      <li class="py-2 pl-3 active"><a href="/dashboard/kelas" class="text-primary">Manajemen Kelas</a></li>
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/kelas/act_edit/<?= $list->id ?>" class="row flex-column col-md-5">
        <label class="input-container-bottom py-2 my-2">
          <div class="small">Kelas</div>
          <input class="w-100" type="number" value="<?= $list->nama ?>" name="nama" required placeholder="1" />
        </label>

        <button class="btn btn-primary w-100 mt-4 py-2">Edit Kelas</button>
      </form>
    </div>
  </section>
