...
<body class="bg-secondary">
  ...
  <aside class="sidebar-container px-3 py-4 bg-white shadow-sm" id="sidebar">
    ...
    <ul>
      ...
      <li class="py-2 pl-3 active"><a href="#" class="text-primary">Manajemen TU</a></li>
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/tu/act_edit/<?= $list->id ?>" class="row flex-column col-md-5">
