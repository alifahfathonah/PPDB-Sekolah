  ...
  <section class="side">
    <div class="container my-4">
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url() ?>/dashboard/kelas/tambah">+Tambah Data</a>
      </div>
          ...
          <tbody>
            <?php foreach ($user as $key => $value) : ?>
              <tr>
                ...
                <td><?= $value->nama ?></td>
                <td>
                  <a href="<?= base_url() . "dashboard/kelas/hapus/{$value->id}" ?>" class="btn btn-danger py-0 btn-sm">Hapus</a>
                  <a href="<?= base_url() . "dashboard/kelas/edit/{$value->id}" ?>" class="btn btn-primary py-0 btn-sm">Edit</a>
                </td>
              </tr>
