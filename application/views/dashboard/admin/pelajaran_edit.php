...
<body class="bg-secondary">
  ...
  <aside class="sidebar-container px-3 py-4 bg-white shadow-sm" id="sidebar">
    ...
    <ul>
      ...
      <li class="py-2 pl-3"><a href="#" class="text-dark">Manajemen TU</a></li>
      ...
      <li class="py-2 pl-3 active"><a href="/dashboard/pelajaran" class="text-primary">Manajemen Pelajaran</a></li>
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/pelajaran/act_edit/<?= $list->id ?>" class="row flex-column col-md-5">
        <label class="input-container-bottom py-2 my-2">
          <div class="small">Kode</div>
          <input class="w-100" type="text" name="kode" value="<?= $list->kode ?>" required placeholder="Masukkan kode disini" />
        </label>

        <label class="input-container-bottom py-2 my-2">
          <div class="small">Nama Pelajaran</div>
          <input class="w-100" type="text" name="nama" value="<?= $list->nama ?>" required placeholder="Matematika" />
        </label>

        <button class="btn btn-primary w-100 mt-4 py-2">Edit Pelajaran</button>
      </form>
    </div>
  </section>
