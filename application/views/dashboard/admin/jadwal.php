  ...
  <section class="side">
    <div class="container my-4">
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url() ?>/dashboard/jadwal/tambah">+Tambah Data</a>
      </div>
            ...
            <?php foreach ($kelas as $value2) : ?>
              <div class="col-4">
                ...
                <?php foreach ($grade as $key2 => $value3) : ?>
                  <a href="<?= base_url() . "/dashboard/jadwal/detail?jurusanid={$value->id}&kelasid={$value2->id}&gradeid={$value3->id}" ?>" class="btn font-weight-bold btn-sm shadow-sm btn-light text-primary py-2 px-4 my-2">
