...
<head>
  ...
  <title>Manajemen Pelajaran</title>
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url() ?>/dashboard/pelajaran/tambah">+ Tambah Data</a>
      </div>
          ...
          <tbody>
            <?php foreach ($list as $key => $value) : ?>
              <tr>
                ...
                <td><?= $value->nama ?></td>
                <td>
                  <a href="<?= base_url() . "dashboard/pelajaran/hapus/{$value->id}" ?>" class="btn btn-danger py-0 btn-sm">Hapus</a>
                  <a href="<?= base_url() . "dashboard/pelajaran/edit/{$value->id}" ?>" class="btn btn-primary py-0 btn-sm">Edit</a>
                </td>
              </tr>
