...
<body class="bg-secondary">
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/grade/act_tambah" class="row flex-column col-md-5">
        <label class="input-container-bottom py-2 my-2">
          <div class="small">Grade</div>
          <input class="w-100" type="text" name="nama" required placeholder="A" />
        </label>

        <button class="btn btn-primary w-100 mt-4 py-2">Tambah Grade</button>
      </form>
    </div>
  </section>
