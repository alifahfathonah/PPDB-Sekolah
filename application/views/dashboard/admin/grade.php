...
<body class="bg-secondary">
  ...
  <aside class="sidebar-container px-3 py-4 bg-white shadow-sm" id="sidebar">
    ...
    <ul>
      ...
      <li class="py-2 pl-3 active"><a href="#" class="text-primary">Manajemen Grade</a></li>
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <div class="d-flex justify-content-between">
        <h4>Manajemen Grade</h4>
        <a href="<?= base_url() ?>/dashboard/grade/tambah">+Tambah Data</a>
      </div>
          ...
          <tbody>
            <?php foreach ($user as $key => $value) : ?>
              <tr>
                ...
                <td><?= $value->nama ?></td>
                <td>
                  <a href="<?= base_url() . "dashboard/grade/hapus/{$value->id}" ?>" class="btn btn-danger py-0 btn-sm">Hapus</a>
                  <a href="<?= base_url() . "dashboard/grade/edit/{$value->id}" ?>" class="btn btn-primary py-0 btn-sm">Edit</a>
                </td>
              </tr>
