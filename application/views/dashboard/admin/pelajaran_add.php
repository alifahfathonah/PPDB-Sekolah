...
<body class="bg-secondary">
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/pelajaran/act_tambah" class="row flex-column col-md-5">
        <label class="input-container-bottom py-2 my-2">
          <div class="small">Kode</div>
          <input class="w-100" type="text" name="kode" required placeholder="Masukkan kode disini" />
        </label>

        <label class="input-container-bottom py-2 my-2">
          <div class="small">Nama Pelajaran</div>
          <input class="w-100" type="text" name="nama" required placeholder="Matematika" />
        </label>

        <button class="btn btn-primary w-100 mt-4 py-2">Tambah Pelajaran</button>
      </form>
    </div>
  </section>
