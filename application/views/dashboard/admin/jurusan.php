  ...
  <section class="side">
    <div class="container my-4">
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url() ?>/dashboard/jurusan/tambah">+Tambah Data</a>
      </div>
          ...
          <tbody>
            <?php foreach ($user as $key => $value) : ?>
              <tr>
                ...
                <td><?= $value->nama ?></td>
                <td>
                  <a href="<?= base_url() . "dashboard/jurusan/hapus/{$value->id}" ?>" class="btn btn-danger py-0 btn-sm">Hapus</a>
                  <a href="<?= base_url() . "dashboard/jurusan/edit/{$value->id}" ?>" class="btn btn-primary py-0 btn-sm">Edit</a>
                </td>
              </tr>
