...
<body class="bg-secondary">
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/jurusan/act_edit/<?= $list->id ?>" class="row flex-column col-md-5">
        ...
        <button class="btn btn-primary w-100 mt-4 py-2">Edit Jurusan</button>
      </form>
    </div>
  </section>
