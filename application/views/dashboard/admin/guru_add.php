...
<body class="bg-secondary">
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/guru/act_tambah" class="row flex-column col-md-5">
        <label class="input-container-bottom py-2 my-2">
          <div class="small">Nama</div>
          <img src="/static/images/icons/user.svg" />
          <input type="text" name="nama" required placeholder="John Doe" class="ml-2" />
        </label>

        <label class="input-container-bottom py-2 my-2">
          <div class="small">Email</div>
          <img src="/static/images/icons/mail.svg" />
          <input type="email" name="email" required placeholder="johndoe89@gmail.com" class="ml-2" />
        </label>
        ...
        <button class="btn btn-primary w-100 mt-4 py-2">Tambah Guru</button>
      </form>
    </div>
  </section>
