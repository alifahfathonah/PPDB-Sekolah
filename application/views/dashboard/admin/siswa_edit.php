...
<body class="bg-secondary">
  ...
  <aside class="sidebar-container px-3 py-4 bg-white shadow-sm" id="sidebar">
    ...
    <ul>
      ...
      <li class="py-2 pl-3 active"><a href="/dashboard/siswa" class="text-primary">Manajemen Siswa</a></li>
    ...
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/siswa/act_edit/<?= $siswa->id ?>" class="row flex-column col-md-5">
        <label class="input-container-bottom py-2 my-2">
          ...
          <input type="text" value="<?= $siswa->nama ?>" name="nama" required placeholder="John Doe" class="ml-2" />
        </label>

        <button class="btn btn-primary w-100 mt-4 py-2">Edit Siswa</button>
      </form>
    </div>
  </section>
