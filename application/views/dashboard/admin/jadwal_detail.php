  ...
  <section class="side">
    <div class="container my-4">
      ...
      <div class="my-3 table-responsive">
        <div>
          <h5>Kelas <?= $kelas->nama . " " . $grade->nama ?></h5>
          <div class="small text-dark my-2"><?= $jurusan->nama ?></div>
        </div>
          ...
          <tbody>
            <?php foreach ($jadwal as $key => $value) : ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url() ?>/dashboard/jadwal/hapus/<?= $value->id ?>" class="btn btn-danger py-1 btn-sm">Hapus</a>
                  <a href="<?= base_url() ?>/dashboard/jadwal/edit/<?= $value->id ?>" class="btn btn-warning py-1 btn-sm">Edit</a>
                </td>
              </tr>
