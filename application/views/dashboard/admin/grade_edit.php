...
<body class="bg-secondary">
  ...
  <section class="side">
    <div class="container my-4">
      ...
      <form method="POST" action="<?= base_url() ?>/dashboard/grade/act_edit/<?= $list->id ?>" class="row flex-column col-md-5">
        <label class="input-container-bottom py-2 my-2">
          <div class="small">Grade</div>
          <input class="w-100" type="text" value="<?= $list->nama ?>" name="nama" required placeholder="Teknik Komputer Jaringan" />
        </label>

        <button class="btn btn-primary w-100 mt-4 py-2">Edit Grade</button>
      </form>
    </div>
  </section>
